...
const Sponsors = () => {
    ...
    return (
        <section id="sponsors" className="py-20 px-4 relative section-alt">
            <div className="max-w-6xl mx-auto">
                ...
                {sponsors.comingSoon && (
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-hackathon-wine mb-2">Sponsors Coming Soon</h3>
                        <p className="text-hackathon-gray/70 text-sm">
                ...
                >
                    <div className="text-center mb-8">
                        <h3 className="text-2xl sm:text-3xl font-bold text-hackathon-wine mb-3">
                            {sponsors.interested.title}
                        </h3>
                        <p className="text-hackathon-gray/70 text-sm sm:text-base max-w-xl mx-auto">
                    ...
                    <div className="flex justify-center mb-10">
                        <a
                            ...
                            className="inline-flex items-center gap-2 bg-hackathon-wine text-white font-bold py-4 px-8 rounded-xl hover:bg-hackathon-crimson hover:shadow-2xl hover:shadow-hackathon-wine/30 transition-all duration-300 transform hover:scale-105 text-sm sm:text-base"
                        >
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        {sponsors.interested.contacts.map((contact, i) => (
                            <div key={i} className="bg-hackathon-wine/5 border border-hackathon-wine/15 rounded-2xl p-5 hover:border-hackathon-wine/30 transition-colors duration-300">
                                <p className="text-hackathon-wine font-bold text-sm mb-0.5">{contact.role}</p>
                                <p className="text-hackathon-gray font-semibold text-base mb-3">{contact.name}</p>
                                <div className="space-y-1.5 text-sm">
                                    <a
                                        href={`tel:${contact.phone}`}
                                        className="flex items-center gap-2 text-hackathon-gray/70 hover:text-hackathon-wine transition-colors"
                                    >
                                    ...
                                    <a
                                        ...
                                        className="flex items-center gap-2 text-hackathon-gray/70 hover:text-hackathon-wine transition-colors break-all"
                                    >
                                        <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
